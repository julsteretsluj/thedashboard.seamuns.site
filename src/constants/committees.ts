...
export const COMMITTEE_OPTIONS = [
  ...
  { value: 'CERN', label: 'CERN — European Organization for Nuclear Research' },
  { value: 'CND', label: 'CND — United Nations Commission on Narcotic Drugs' },
  { value: 'CoM', label: 'CoM — Council of Marvels (Fictional)' },
  { value: 'CPD', label: 'CPD — Commission on Population and Development' },
  { value: 'CSTD', label: 'CSTD — Commission on Science and Technology for Development' },
  { value: 'DGC', label: 'DGC — United Nations Department of Global Communications' },
  ...
  { value: 'EP', label: 'EP — European Parliament' },
  ...
  { value: 'ICC-Commerce', label: 'ICC — International Chamber of Commerce' },
  { value: 'ICJ', label: 'ICJ — International Court of Justice' },
  { value: 'ICRC', label: 'ICRC — International Committee of the Red Cross' },
  ...
  { value: 'UNCSA', label: 'UNCSA — Commission on Superhuman Activities (Fictional)' },
  { value: 'UNCTAD', label: 'UNCTAD — United Nations Conference on Trade and Development' },
  { value: 'UNEP', label: 'UNEP — United Nations Environmental Program' },
  { value: 'UNESCO', label: 'UNESCO — UN Educational, Scientific, and Cultural Organization' },
  { value: 'UNHCR', label: 'UNHCR — UN High Commissioner for Refugees' },
  { value: 'UNICEF', label: 'UNICEF — United Nations Children\'s Fund' },
  { value: 'UNIDO', label: 'UNIDO — UN Industrial Development Organization' },
  { value: 'UNISDR', label: 'UNISDR — United Nations Office for Disaster Risk Reduction' },
  { value: 'UNODC', label: 'UNODC — United Nations Office on Drugs and Crime' },
  { value: 'UNOOSA', label: 'UNOOSA — United Nations Office for Outer Space Affairs' },
  ...
  { value: 'WIPO', label: 'WIPO — World Intellectual Property Organization' },
